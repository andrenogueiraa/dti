...
import createProject, { getDevTeams } from "./server-actions";
import {
  Select,
  SelectContent,
  SelectItem,
...
export default function CreateProject() {
  const devTeamsQuery = useQuery({
    queryKey: ["dev-teams"],
    queryFn: async () => await getDevTeams(),
  });
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    {devTeamsQuery.isLoading ? (
                      <Select disabled>
                        <SelectTrigger>
                          <SelectValue placeholder="Loading..." />
                        </SelectTrigger>
                      </Select>
                    ) : devTeamsQuery.isError ? (
                      <Select disabled>
                        <SelectTrigger>
                          <SelectValue placeholder="Error loading teams" />
                        </SelectTrigger>
                      </Select>
                    ) : devTeamsQuery.isSuccess &&
                      ...
                      <Select disabled>
                        <SelectTrigger>
                          <SelectValue placeholder="No teams found" />
                        </SelectTrigger>
                      </Select>
                    ) : (
                      "Erro desconhecido"
